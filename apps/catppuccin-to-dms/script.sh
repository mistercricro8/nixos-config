...
result="$(echo "$input_content" | perl -pe '
    ...
    s/#6c7086([0-9a-fA-F]{2})?/\%outline\%$1/gi;
    s/#7f849c([0-9a-fA-F]{2})?/\%on_surface_variant\%$1/gi;
    ...
    s/#94e2d5([0-9a-fA-F]{2})?/\%secondary\%$1/gi;
    s/#89dceb([0-9a-fA-F]{2})?/\%primary_fixed\%$1/gi;
    s/#74c7ec([0-9a-fA-F]{2})?/\%primary_fixed\%$1/gi;
    s/#89b4fa([0-9a-fA-F]{2})?/\%primary\%$1/gi;
    s/#b4befe([0-9a-fA-F]{2})?/\%primary_fixed\%$1/gi;
    ...
    s/#6e738d([0-9a-fA-F]{2})?/\%outline\%$1/gi;
    s/#8087a2([0-9a-fA-F]{2})?/\%on_surface_variant\%$1/gi;
    ...
    s/#8bd5ca([0-9a-fA-F]{2})?/\%secondary\%$1/gi;
    s/#91d7e3([0-9a-fA-F]{2})?/\%primary_fixed\%$1/gi;
    s/#7dc4e4([0-9a-fA-F]{2})?/\%primary_fixed\%$1/gi;
    s/#8aadf4([0-9a-fA-F]{2})?/\%primary\%$1/gi;
    s/#b7bdf8([0-9a-fA-F]{2})?/\%primary_fixed\%$1/gi;
    ...
    s/#736f8d([0-9a-fA-F]{2})?/\%outline\%$1/gi;
    s/#837fc1([0-9a-fA-F]{2})?/\%on_surface_variant\%$1/gi;
    ...
    s/#81c8be([0-9a-fA-F]{2})?/\%secondary\%$1/gi;
    s/#99d1db([0-9a-fA-F]{2})?/\%primary_fixed\%$1/gi;
    s/#85c1dc([0-9a-fA-F]{2})?/\%primary_fixed\%$1/gi;
    s/#8caaee([0-9a-fA-F]{2})?/\%primary\%$1/gi;
    s/#babbf1([0-9a-fA-F]{2})?/\%primary_fixed\%$1/gi;
    ...
    s/#9ca0b0([0-9a-fA-F]{2})?/\%outline\%$1/gi;
    s/#8c8fa1([0-9a-fA-F]{2})?/\%on_surface_variant\%$1/gi;
    ...
    s/#179299([0-9a-fA-F]{2})?/\%secondary\%$1/gi;
    s/#04a5e5([0-9a-fA-F]{2})?/\%primary_fixed\%$1/gi;
    s/#209fb5([0-9a-fA-F]{2})?/\%primary_fixed\%$1/gi;
    s/#1e66f5([0-9a-fA-F]{2})?/\%primary\%$1/gi;
    s/#7287fd([0-9a-fA-F]{2})?/\%primary_fixed\%$1/gi;
