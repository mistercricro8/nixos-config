...
hl.define_submap("music", function()
  ...
  bind_nav({ mod = "", arrow = "Right", vim = "L" }, function() hl.dispatch(hl.dsp.exec_cmd("playerctl next")) end)
  bind_nav({ mod = "", arrow = "Left", vim = "H" }, function() hl.dispatch(hl.dsp.exec_cmd("playerctl previous")) end)
