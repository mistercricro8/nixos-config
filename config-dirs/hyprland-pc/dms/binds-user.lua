...
hl.define_submap("music", function()
  hl.bind("P", function() hl.dsp.exec_cmd("playerctl play-pause")() end)
  hl.bind("I", function() hl.dsp.exec_cmd("playerctl volume 0.1+")() end, { repeating = true })
  hl.bind("O", function() hl.dsp.exec_cmd("playerctl volume 0.1-")() end, { repeating = true })
  hl.bind("Right", function() hl.dsp.exec_cmd("playerctl next")() end)
  hl.bind("Left", function() hl.dsp.exec_cmd("playerctl previous")() end)
  hl.bind("S", function() hl.dsp.exec_cmd("mpv --shuffle=yes --loop-playlist=inf --really-quiet $MUSIC_PATH")() end)
  hl.bind("D", function() hl.dsp.exec_cmd("playerctl stop mpv")() end)
  hl.bind("escape", function() hl.dsp.submap("reset")() end)
end)
hl.bind(mainMod .. " + M", function() hl.dsp.submap("music")() end)
