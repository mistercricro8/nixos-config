# The static part of the constants module and its declaration
{ ... }:
let
  # For remote building nix uses the root user, so these are keys under /root/.ssh.
  buildKeys = [
  ...
  # Keys from other people that should have access to public facing hosts.
  otherKeys = [
